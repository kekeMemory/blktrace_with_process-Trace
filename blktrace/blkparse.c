...
** Get proc/pid/stat
*/
struct tstat current_pid_stat(u32 pid){
	//printf("Start pid stat func()\n");
    struct tstat stat_info;
    FILE *fp;
	int	nr;
    char filepath[256];
	...
	*/
    ...
    sprintf(filepath,"/proc/%u/stat", pid);
    fp=fopen(filepath,"r");
	//printf("open stat file of pid %u\n", current_pid);
    if(fp == NULL)
	{
		printf("Cannot open stat file of pid %u\n", pid);
		stat_info.error = 1;
		return stat_info;
	}
	...
	{
		printf("Cannot read stat file of pid %u\n", pid);
		fclose(fp);
		stat_info.error = 1;
		return stat_info;
	}
	...
	*/
	...
	{
		printf("parsing fail during cmd name parse\n");
		fclose(fp);
		stat_info.error = 1;
		return stat_info;
	}
	...
	//printf("param size %lu\n", sizeof(stat_info.gen.name));
	memcpy(stat_info.gen.name, cmdhead+1, nr);
	// printf("Parse command name ""%s""\n", stat_info.gen.name);			//Here , No working
	...
	sscanf(line, "%d", &(stat_info.gen.pid));  /* fetch pid */
	// printf("%d %s\n", stat_info.gen.pid, stat_info.gen.name);

	sscanf(cmdtail+2, "%c %d %d %d %d %d %u %lu %lu %lu %lu %lu %lu %ld %ld %ld %ld %ld %ld %llu %lu %ld %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %d %d %u %u %llu %lu %ld %lu %lu %lu %lu %lu %lu %lu %d",
				&stat_info.gen.state, &stat_info.gen.ppid, &stat_info.gen.pgrp, &stat_info.gen.session, &stat_info.gen.tty_nr,
				&stat_info.gen.tpgid, &stat_info.gen.flags, &stat_info.mem.minflt, &stat_info.mem.cminflt, &stat_info.mem.majflt,
				&stat_info.mem.cmajflt, &stat_info.cpu.utime, &stat_info.cpu.stime, &stat_info.cpu.cutime, &stat_info.cpu.cstime,
				&stat_info.cpu.priority, &stat_info.cpu.nice, &stat_info.gen.num_threads, &stat_info.gen.itrealvalue, &stat_info.gen.starttime,
				&stat_info.mem.vsize, &stat_info.mem.rss, &stat_info.mem.rsslim, &stat_info.gen.startcode, &stat_info.gen.endcode,
				&stat_info.gen.startstack, &stat_info.gen.kstkesp, &stat_info.gen.kstkeip, &stat_info.gen.signal, &stat_info.gen.blocked,
				&stat_info.gen.sigignore, &stat_info.gen.sigcatch, &stat_info.cpu.wchan, &stat_info.gen.nswap, &stat_info.gen.cnswap,
				&stat_info.gen.exit_signal, &stat_info.cpu.processor, &stat_info.cpu.rt_priority, &stat_info.cpu.policy, &stat_info.dsk.delayacct_blkio_ticks,
				&stat_info.cpu.guest_time, &stat_info.cpu.cguest_time, &stat_info.gen.start_data, &stat_info.gen.end_data, &stat_info.gen.start_brk,
				&stat_info.gen.arg_start, &stat_info.gen.arg_end, &stat_info.gen.env_start, &stat_info.gen.env_end, &stat_info.gen.exit_code);
	// printf("%c %d %d %d %d \n%d %u %lu %lu %lu\n %lu %lu %lu %ld %ld\n %ld %ld %ld %ld %llu\n %lu %ld %lu %lu %lu\n %lu %lu %lu %lu %lu\n %lu %lu %lu %lu %lu\n %d %d %u %u %llu \n%lu %ld %lu %lu %lu \n%lu %lu %lu %lu %d\n",
				// stat_info.gen.state, stat_info.gen.ppid, stat_info.gen.pgrp, stat_info.gen.session, stat_info.gen.tty_nr, 
				// stat_info.gen.tpgid, stat_info.gen.flags, stat_info.mem.minflt, stat_info.mem.cminflt, stat_info.mem.majflt, 
				// stat_info.mem.cmajflt, stat_info.cpu.utime, stat_info.cpu.stime, stat_info.cpu.cutime, stat_info.cpu.cstime, 
    ...
    //sscanf(parse, "%d %s %c %d %d %d %d %d %u %lu %lu %lu %lu %lu %lu %ld %ld %ld %ld %ld %ld %llu %lu %ld %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu %d %d %u %u %llu %lu %ld %lu %lu %lu %lu %lu %lu %lu %d",
    //            &stat_info.gen.pid, &stat_info.gen.name, &stat_info.gen.state, &stat_info.gen.ppid, &stat_info.gen.pgrp,
    //            &stat_info.gen.session, &stat_info.gen.tty_nr, &stat_info.gen.tpgid, &stat_info.gen.flags, &stat_info.mem.minflt,
    //                &stat_info.mem.cminflt, &stat_info.mem.majflt, &stat_info.mem.cmajflt, &stat_info.cpu.utime, &stat_info.cpu.stime,
    //                &stat_info.cpu.cutime, &stat_info.cpu.cstime, &stat_info.cpu.priority, &stat_info.cpu.nice, &stat_info.gen.num_threads,
    //                 &stat_info.gen.itrealvalue, &stat_info.gen.starttime, &stat_info.mem.vsize, &stat_info.mem.rss, &stat_info.mem.rsslim,
    //                 &stat_info.gen.startcode, &stat_info.gen.endcode, &stat_info.gen.startstack, &stat_info.gen.kstkesp, &stat_info.gen.kstkeip,
    //                 &stat_info.gen.signal, &stat_info.gen.blocked, &stat_info.gen.sigignore, &stat_info.gen.sigcatch, &stat_info.cpu.wchan,
    //                 &stat_info.gen.nswap, &stat_info.gen.cnswap, &stat_info.gen.exit_signal, &stat_info.cpu.processor, &stat_info.cpu.rt_priority,
    //                 &stat_info.cpu.policy, &stat_info.dsk.delayacct_blkio_ticks, &stat_info.cpu.guest_time, &stat_info.cpu.cguest_time, &stat_info.gen.start_data,
    //                 &stat_info.gen.end_data, &stat_info.gen.start_brk, &stat_info.gen.arg_start, &stat_info.gen.arg_end, &stat_info.gen.env_start, &stat_info.gen.env_end, &stat_info.gen.exit_code);
    //fclose(fp);
    return stat_info;
