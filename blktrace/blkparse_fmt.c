			...
			int minus, int has_w, int width)
{
	...
	case 'J':
	{
		if(t->pid == 0)
			...
			abort();
		statp=current_pid_stat(t->pid);
		if(statp.error == 1) //file open error
			break;

		fprintf(ofp, "%d,%s,%c,%d,%d,%d,%d,%d,%u,%lu,%lu,%lu,%lu,%lu,%lu,%ld,%ld,%ld,%ld,%ld,%ld,%llu,%lu,%ld,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%d,%d,%u,%u,%llu,%lu,%ld,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%d",
		statp.gen.pid, statp.gen.name, statp.gen.state, statp.gen.ppid, statp.gen.pgrp,
        statp.gen.session, statp.gen.tty_nr, statp.gen.tpgid, statp.gen.flags, statp.mem.minflt,
        statp.mem.cminflt, statp.mem.majflt, statp.mem.cmajflt, statp.cpu.utime, statp.cpu.stime,
        statp.cpu.cutime, statp.cpu.cstime, statp.cpu.priority, statp.cpu.nice, statp.gen.num_threads,
        statp.gen.itrealvalue, statp.gen.starttime, statp.mem.vsize, statp.mem.rss, statp.mem.rsslim,
        statp.gen.startcode, statp.gen.endcode, statp.gen.startstack, statp.gen.kstkesp, statp.gen.kstkeip,
        statp.gen.signal, statp.gen.blocked, statp.gen.sigignore, statp.gen.sigcatch, statp.cpu.wchan,
        statp.gen.nswap, statp.gen.cnswap, statp.gen.exit_signal, statp.cpu.processor, statp.cpu.rt_priority,
        statp.cpu.policy, statp.dsk.delayacct_blkio_ticks, statp.cpu.guest_time, statp.cpu.cguest_time, statp.gen.start_data,
        statp.gen.end_data, statp.gen.start_brk, statp.gen.arg_start, statp.gen.arg_end, statp.gen.env_start,
		statp.gen.env_end, statp.gen.exit_code);
		break;
	}
	default:
